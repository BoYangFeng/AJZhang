...
infosoftglobal.FusionCharts.prototype = {
	...
	render: function(elementId, loaded){
		...
		if((this.detectFlashVersion==1) && (this.installedVer.major < 8)){
			...
			// If loaded in IE and scaleMode and width/height specified in %, load the chart using onload event
                        ...
                        if(loaded && this.getVariable('scaleMode').search(/noscale/i)>=0 && ( this.getAttribute('width').search("%")>0 || this.getAttribute('height').search("%")>0) )
			{
